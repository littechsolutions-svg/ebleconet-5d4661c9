      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-card border border-border rounded-3xl p-8 sm:p-12 glow-card">
          ...
          <div className="space-y-6 text-muted-foreground leading-relaxed">
            ...
            <h2 className="text-2xl font-bold text-foreground mt-8">The Philosophy Behind Ebleco</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-foreground mt-8">Scientific Foundations of Ebleco</h2>
            
            <h3 className="text-xl font-semibold text-primary mt-6">Epigenetics:</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-primary mt-6">Neuroplasticity:</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-primary mt-6">Psychoneuroimmunology:</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-primary mt-6">Self-Hypnosis and Autosuggestion:</h3>
            <p>

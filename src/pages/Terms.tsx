    ...
    <div className="min-h-screen bg-background py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-card border border-border rounded-3xl p-8 sm:p-12 glow-card">
          <h1 className="text-4xl sm:text-5xl font-bold text-gradient mb-4 animate-fade-in-wave">
            Terms and Conditions
          </h1>
          <p className="text-sm text-muted-foreground mb-8 animate-fade-in-wave stagger-1">Last Updated: Jul 20, 2025</p>

          <div className="space-y-6 text-muted-foreground leading-relaxed">
            <p className="animate-fade-in-wave stagger-2">
            ...
            <section className="animate-fade-in-wave stagger-3">
            ...
            <section className="animate-fade-in-wave stagger-4">
            ...
            <section className="animate-fade-in-wave stagger-5">
            ...
            <section className="animate-fade-in-wave stagger-6">
            ...
            <section className="animate-fade-in-wave stagger-7">
